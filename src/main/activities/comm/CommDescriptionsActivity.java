package hexa.congressApp.com.congress.activities.comm;
...
import hexa.congressApp.com.congress.activities.bills.BillsDiescriptionsActivity;
import hexa.congressApp.com.congress.activities.favourites.FavouriteActivity;
import hexa.congressApp.com.congress.activities.legislators.SingleMemberActivity;
...
public class CommDescriptionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(CommDescriptionsActivity.this).load(imgUrl).resize(180, 180).into(chamberImage);
        ...
        commChamberText.setText(commChamber.substring(0,1).toUpperCase() + commChamber.substring(1));
        //
