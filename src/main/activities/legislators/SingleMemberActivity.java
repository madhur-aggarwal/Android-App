package hexa.congressApp.com.congress.activities.legislators;
...
import hexa.congressApp.com.congress.activities.favourites.FavouriteActivity;
import hexa.congressApp.com.congress.constants.Constants;
...
public class SingleMemberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(SingleMemberActivity.this).load(flagUrl).resize(170, 170).into(flag);
        ...
        Picasso.with(SingleMemberActivity.this).load(Constants.IMAGE_URL + imageUrl + ".jpg").resize(180, 220).into(personImage);
        final ImageView facebookimage = (ImageView) findViewById(R.id.facebook);
        facebookimage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (!(facebook.equals(" ")|| facebook.equals("null"))) {
        ...
        final ImageView twitterImage = (ImageView) findViewById(R.id.twitter);
        twitterImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (!(twitter.equals(" ")|| twitter.equals("null"))) {
...
//        Log.e("facebookUrl",website);
        ...
        chamberText.setText(chamber.substring(0,1).toUpperCase() + chamber.substring(1));
            ...
            public void onClick(View view) {
                if(emailText.getText().toString().equals("N.A.")){
                    ...
                    Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                            "Mail To",emailText.getText().toString(), null));
