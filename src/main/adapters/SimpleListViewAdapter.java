...
import hexa.congressApp.com.congress.customList.StringMatcher;
...
public class SimpleListViewAdapter extends ArrayAdapter<LegislatorsModel> implements SectionIndexer {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Holder holder;
            ...
            Picasso.with(con).load(Constants.IMAGE_URL+name.get(position).getImageUrl()+".jpg").resize(220, 250).into(holder.img);
